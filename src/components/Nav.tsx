...
export default function Nav() {
  ...
  return (
    <>
      ...
      >
        <div className="flex">
          <Link href="/" className={`flex-1 flex flex-col items-center justify-center py-3 gap-1 text-[10px] font-medium ${isActive('/') && pathname === '/' ? 'text-blue-600' : 'text-gray-500'}`}>
          ...
          <Link href="/threads" className={`flex-1 flex flex-col items-center justify-center py-3 gap-1 text-[10px] font-medium ${isActive('/threads') ? 'text-blue-600' : 'text-gray-500'}`}>
            <svg className="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <button
            onClick={openSheet}
            className={`flex-1 flex flex-col items-center justify-center py-3 gap-1 text-[10px] font-medium ${menuMounted ? 'text-blue-600' : 'text-gray-500'}`}
          >
            <svg className="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          >
            ...
            <div className="px-4 pb-2">
              ...
              <nav className="space-y-0.5">
                ...
                <Link
                  href="/scheduled"
                  className={`flex items-center gap-3 px-3 py-3 rounded-xl text-sm font-medium transition-colors ${isActive('/scheduled') ? 'bg-blue-50 text-blue-700' : 'text-gray-700 hover:bg-gray-100'}`}
                >
                  <svg className="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
